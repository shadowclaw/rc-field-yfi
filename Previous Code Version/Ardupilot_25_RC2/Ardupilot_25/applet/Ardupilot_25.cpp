...
void navigate()
{
	...
	if (control_mode == LOITER){
		...
		//if (wp_index > 0){
			// only fire this if we are doing WPs
			// ----------------------------------
...
void init_PWM()
{
	...
	OCR2A 	= 125; //1500us/8; The top, when the counter reaches the value definied here will execute the interrupt, 187 is the servo centered... 
