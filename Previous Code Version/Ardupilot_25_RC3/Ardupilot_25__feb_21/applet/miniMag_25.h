...
#define AIRSPEED_SENSOR 0 // 1 if an airspeed sensor is attached and pitot tube connect. 0 if not (throttle will restricted to altitude error)
...
//2-2
#define XY_SENSOR_LOCATION 2 //XY Thermopiles Sensor placement
...
//ATTITUDE: ROLL GAINS
//7-1
#define ROLL_P .65 // 	START WITH THIS VALUE TO TUNE - overall proportional term determines how much rudder you use to turn.
//7-2	
...
//9-5
#define THROTTLE_CRUISE 30 // (0-125) %throttle, or (int)target airspeed for cruising
//9-6
