...
void loop()
{
	...
	}else if ((control_mode >= AUTO) && (control_mode < CONSTANTPITCH)){
...
else if (control_mode == CONSTANTPITCH){
          
          nav_pitch=1000*REVERSE_PITCH;
          nav_roll=0;
