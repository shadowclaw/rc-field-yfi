...
//6-3
#define ALTITUDE_AIRSPEED_MIN -40 //(0-125) Maximum reduced speed for loosing altitude
//6-4
...
//7-3
#define RUDDER_MAX 3000 // (Degrees *100) Maximum output of Rudder
...
//9-6
#define THROTTLE_MAX 50 // (0-125) 60 = 48% maximum throttle
