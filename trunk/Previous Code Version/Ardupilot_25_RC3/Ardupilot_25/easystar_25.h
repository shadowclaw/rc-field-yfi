...
//4-2
#define HEAD_MAX 5000 //(Degrees *100) The maximum output in degrees to control the roll setpoint
//4-3
#define HEAD_MIN -5000 //(Degrees *100) The min output in degrees to control the roll setpoint
//4-4
...
//5-2
#define ALTITUDE_PITCH_MAX 2500 // most the plane will pitch up in degrees to raise altitude
//5-3
...
//ATTITUDE: ROLL GAINS
//7-1
#define ROLL_P .60 // 	START WITH THIS VALUE TO TUNE - overall proportional term determines how much rudder you use to turn.
//7-2	
#define ROLL_I 0 //	roll PID integrator
//7-3
#define ROLL_MIN -3800 // maximum output of Rudder
//7-4
#define ROLL_MAX 3800 // maximum output of Rudder
...
//9-2
#define THROTTLE_P .14 //Proportional
//9-3
#define THROTTLE_I 0 //Integrator
//9-4
#define THROTTLE_I_MAX 50 // (0-125) 50=70% Integrator limit. 
//9-5
#define THROTTLE_CRUISE 35 // (0-125) %throttle, or (int)target airspeed for cruising
//9-6
