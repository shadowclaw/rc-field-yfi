...
//4-2
#define HEAD_MAX 4000 //(Degrees *100) The maximum output in degrees to control the roll setpoint
//4-3
#define HEAD_MIN -4000 //(Degrees *100) The min output in degrees to control the roll setpoint
//4-4
...
//5-2
#define ALTITUDE_PITCH_MAX 3000 // most the plane will pitch up in degrees to raise altitude
//5-3
...
//ATTITUDE: ROLL GAINS
//7-1
#define ROLL_P .68 // 	START WITH THIS VALUE TO TUNE - overall proportional term determines how much rudder you use to turn.
//7-2	
#define ROLL_I 0 //	roll PID integrator
//7-3
#define ROLL_MIN -6000 // maximum output of Rudder
//7-4
#define ROLL_MAX 6000 // maximum output of Rudder
...
//8-2
#define PITCH_I 0 //	Pitch integrator
//8-3
#define PITCH_COMP .40 //<------Very important, Pitch compensation vs. Roll bank angle. 
...
//9-2
#define THROTTLE_P .10 //Proportional
//9-3
#define THROTTLE_I 0 //Integrator
//9-4
#define THROTTLE_I_MAX 50 // (0-125) 50=70% Integrator limit. 
//9-5
#define THROTTLE_CRUISE 33 // (0-125) %throttle, or (int)target airspeed for cruising
//9-6
#define THROTTLE_MAX 50 // (0-125) 70 = 56% maximum throttle
...
//10-3
#define CLIMBRATE_UP 2000 // (meters * 100) how fast we climb in simulator at 90° 
//10-4
