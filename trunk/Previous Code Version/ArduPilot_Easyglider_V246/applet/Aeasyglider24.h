...
/* Ardupilot v2.4.6, good luck!             */
/* Tested in flight on Dec 1, 2009         */
/* By Jean-Louis Naudin                     */
/********************************************/
// 11-04-09 : JLN Added 1-7 GPS_PROTOCOL 3 for GPS Emulator
// 11-10-09 : JLN The BEST TUNING for My EASYGLIDER wooww !!!
// 11-13-09 : JLN Added 8-10 GSP_MINIMUM, the desired minimum ground speed in case of strong front wind

//Hardware Configuration
//0-1
#define SHIELD_VERSION 0 // Old (red) shield versions is 0, the new (blue) shield version is 1
...
//1-7
#define GPS_PROTOCOL 2 // 0 = NMEA, 1=SIRF, 2=uBlox, 3=GPSEmulator : Choose protocol
//1-8
...
//1-11
#define INTPUT_VOLTAGE 4980.0 // voltage in millis your power regulator is feeding your ArduPilot. Measure and set this to have an accurate pressure and battery level readings. (you need a multimeter to measure this of course).
//1-12
...
//HEADING GAINS
//4-1
#define head_P 0.6 //Heading error proportional (same used to move the rudder)... DO not add too much or you will oscillate left and right.  (drunk driver effect)
//4-2
...
//6-7
#define PITCH_COMP .3 //<------Very important, Pitch compensation vs. Roll bank angle. 
...
//8-7
#define ALTITUDE_ERROR_AIRSPEED_PROPORTIONAL 4  // 4
//8-8
#define ALTITUDE_ERROR_AIRSPEED_MAX 30  // 30
//8-9
#define ALTITUDE_ERROR_AIRSPEED_MIN -10
//8-10
#define GSP_MINIMUM 8  // Set the minimum groundspeed in m/s in case of strong front wind
