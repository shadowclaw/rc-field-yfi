...
//3-4
#define CH1_MIN 600 // (Microseconds) Range of Ailerons/ Rudder
//3-5
#define CH1_MAX 2400 // (Microseconds)
//3-6
#define CH2_MIN 600 // (Microseconds) Range of Elevator
//3-7
#define CH2_MAX 2400 // (Microseconds)
//3-8
...
<<<<<<< .mine
#define HEAD_P .8 //Heading error proportional (same used to move the rudder)... DO not add too much or you will oscillate left and right.  (drunk driver effect)
=======
#define HEAD_P .6 //Heading error proportional (same used to move the rudder)... DO not add too much or you will oscillate left and right.  (drunk driver effect)
>>>>>>> .r78
//4-1
<<<<<<< .mine
...
//4-5
#define HEAD_I_MIN -500 //(Degrees *100) The min output in degrees to control the roll setpoint
//4-6
#define XTRACK_GAIN .2 // amount to compensate for crosstrack - use debug mode to find correct value
//4-7
#define LOITER_RADIUS 30 // radius in meters of a Loiter
//4-8
...
//4-9
#define WP_ALTITUDE_RADIUS 20 // (meters) accuracy needed to find our waypoint in meters
...
//5-2
<<<<<<< .mine
#define ALTITUDE_PITCH_MAX 0 // most the plane will pitch up in degrees to raise altitude
=======
#define ALTITUDE_PITCH_MAX 100 // most the plane will pitch up in degrees to raise altitude
>>>>>>> .r78
//5-3
#define ALTITUDE_PITCH_MIN -1000 // (Degrees *100) most the plane will pitch down in degrees to lower altitude 
...
//ATTITUDE: ROLL GAINS
//7-1
#define ROLL_P .35 // 	START WITH THIS VALUE TO TUNE - overall proportional term determines how much rudder you use to turn.
//7-2	
<<<<<<< .mine
#define ROLL_I 0 //	roll PID integrator
=======
